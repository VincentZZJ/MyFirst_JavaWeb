...
<body>
	<center>
    <table border="0" cellpadding="0" cellspacing="0" width="688" height="500">
                    ...
                    <tr>
                        <td align="center">
                            <table border="0" width="650" rules="all" cellspacing="8">                    
                                ...
                                <tr><td colspan="3" align="center"><s2:textarea id="content" name="infoSingle.infoContent" rows="12" cols="78" onkeydown="check(content,ContentUse,ContentRem,500)" onkeyup="check(content,ContentUse,ContentRem,500)" onchange="check(content,ContentUse,ContentRem,500)"/></td></tr>
